...
generate_gradient "$IMAGES_ROOT/female_host/warm_sunrise_03.png" "255,191,210" "255,132,92" "255,243,214" "sqrt((X-W*0.2)^2+(Y-H*0.1)^2)/(sqrt(W*W+H*H))" "Y/H"
...
generate_gradient "$IMAGES_ROOT/male_host/cool_modern_03.png" "11,28,52" "64,125,214" "3,8,18" "sqrt((X-W*0.8)^2+(Y-H*0.15)^2)/(sqrt(W*W+H*H))" "Y/H"

generate_gradient "$IMAGES_ROOT/psych_host/mystery_depth_01.png" "14,7,28" "87,39,140" "0,0,0" "X/W" "Y/H"
generate_gradient "$IMAGES_ROOT/psych_host/mystery_depth_02.png" "22,9,36" "118,56,169" "2,2,6" "(X+Y)/W" "sqrt((X-W*0.5)^2+(Y-H*0.2)^2)/(sqrt(W*W+H*H))"
generate_gradient "$IMAGES_ROOT/psych_host/mystery_depth_03.png" "10,4,20" "73,26,120" "0,0,0" "sqrt((X-W*0.5)^2+(Y-H*0.55)^2)/(sqrt(W*W+H*H))" "(Y*0.9)/H"
